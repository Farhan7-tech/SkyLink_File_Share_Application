            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
                    {pricingPlans.map((plan, index) => (
                        <div key={index} className={`flex flex-col rounded-lg shadow-lg overflow-hidden transition-all duration-300 ${plan.highlighted ? 'border-2 border-purple-500 transform scale-105 z-10': 'border border-gray-200 dark:border-gray-700'}`}>
                            <div className={`px-6 py-8 bg-white dark:bg-gray-800 ${plan.highlighted ? 'bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-800': ''}`}>
                            ...
                            <div className="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 dark:bg-gray-800/50 space-y-6">
                                ...
                                <div className="rounded-md shadow">
                                    <button
                                        onClick={() => openSignUp()}
                                        className={`w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md ${plan.highlighted ? 'text-white bg-purple-500 hover:bg-purple-600': 'text-purple-600 bg-white hover:bg-gray-50 border-purple-500 dark:bg-gray-700 dark:text-purple-400 dark:hover:bg-gray-600 dark:border-purple-500/50'} transition-colors duration-200`}>
                                        {plan.cta}
                                    </button>
                                </div>
                            </div>
