    ...
    <div className="w-full max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-medium dark:text-white">Upload Files</h2>
        </div>
      ...
      <div
        className="border-dashed border-2 border-gray-300 rounded-lg p-8 text-center bg-white cursor-pointer hover:border-blue-500 transition-colors dark:bg-gray-800 dark:border-gray-600 dark:hover:border-blue-500"
        onDragOver={handleDragOver}
        onDrop={handleDrop}
        onClick={handleBrowseClick}
      >
        <div className="flex flex-col items-center justify-center">
          <div className="p-3 rounded-full bg-blue-50 mb-4 dark:bg-blue-900/50">
      ...
      {files.length > 0 && (
        <div className="mt-6">
          <h3 className="text-sm font-medium mb-2 dark:text-gray-400">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden dark:bg-gray-800 dark:border-gray-700">
            {files.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 border-b last:border-b-0 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-700"
              >
