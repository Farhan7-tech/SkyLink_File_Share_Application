...
const FileCard = ({
  ...
  return (
    <div
      ...
      className="relative group overflow-hidden rounded-xl bg-white shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:shadow-purple-500/10"
    >
      {/* File preview area */}
      <div className="h-32 bg-gradient-to-br from-purple-50 to-indigo-50 flex items-center justify-center p-4 dark:from-purple-900/50 dark:to-indigo-900/50">
        {getFileIcon(file)}
      </div>
      ...
      <div className="absolute top-2 right-2">
        <div
          className={`rounded-full p-1.5 ${file.isPublic ? "bg-green-100 dark:bg-green-900/50" : "bg-gray-100 dark:bg-gray-700"}`}
      ...
      <div className="p-4">
        <div className="flex justify-between items-start">
          <div className="overflow-hidden">
            <h3
              title={file.name}
              className="font-medium text-gray-900 truncate dark:text-gray-200"
            >
              {file.name}
            </h3>
