    ...
    <DashboardLayout activeMenu="Subscription">
      <div className="p-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          <div className="bg-blue-50 p-6 rounded-lg dark:bg-gray-800">
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`border rounded-xl p-6 ${
                plan.recommended
                  ? "border-purple-200 bg-purple-50 shadow-md dark:bg-gray-800 dark:border-purple-500"
              ...
              <button
                ...
                className={`w-full py-2 rounded-md font-medium transition-colors ${
                  plan.recommended
                    ...
                    : "bg-white border border-purple-500 text-purple-500 hover:bg-purple-50 dark:bg-transparent dark:hover:bg-purple-500/10"
        ...
        <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          <h3 className="font-medium mb-2 dark:text-white">How credits work</h3>
