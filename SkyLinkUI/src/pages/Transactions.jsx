    ...
    return (
        <DashboardLayout activeMenu="Transactions">
            <div className="p-6">
                ...
                {error && (
                    <div className="mb-6 p-4 bg-red-50 text-red-700 rounded-lg flex items-center gap-2 dark:bg-red-900/50 dark:text-red-300">
                        <AlertCircle size={20} />
                        <span>{error}</span>
                    </div>
                )}
                ...
                {loading ? (
                    ...
                    <div className="bg-gray-50 p-8 rounded-lg text-center dark:bg-gray-800">
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full bg-white rounded-lg overflow-hidden shadow dark:bg-gray-800">
                            ...
                            {transactions.map((transaction) => (
                                <tr key={transaction.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 font-mono dark:text-gray-400">
